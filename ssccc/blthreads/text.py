with open(__file__[0:__file__.rfind("/")+1] + "textdata") as datafile:
    ...
    if newchar == True:
        ...
        if line=="":
            ...
            if width == 0:
                ...
                raise Exception, "Error in text data file: wrong width"
            for pixel in line:
                if pixel=="#":
                    row += ["\x01"]
                elif pixel==".":
                    ...
                    raise Exception, "Error in text data file: unknown symbol in pixel data"
            textdata[char] += [row]
